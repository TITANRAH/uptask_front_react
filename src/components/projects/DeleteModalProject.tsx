...
import { checkUserPassword } from "@/api/AuthApi";
...
export default function DeleteProjectModal() {
  ...
  const deleteProjectId = useQueryParams("deleteProject");
  ...
  const handleForm = async (formData: CheckPasswordForm) => {
    ...
    // TODO: MUTACION ASYNCRONA y MULTIPLE MUTACION, VAN EN ORDEN SI LA PRIEMRA NO SE EJECUTA NO SIGUE

    await checkUserPasswordMutation.mutateAsync(formData);
    await deleteProjectMutation.mutateAsync(deleteProjectId);

    console.log("despue de la mutacion");
  };
