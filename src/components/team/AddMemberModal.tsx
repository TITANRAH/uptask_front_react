...
export default function AddMemberModal() {
    ...
    // TODO: ESTADO EN LA URL PARA MOSTRAR EL MODAL

    // COMO EN EL BOTON PARA IR A ESTA VISTA AGREGUA UN QUERY STRING AQUI SOLO LO LEEMOS
                    ...
                    <div className="fixed inset-0 overflow-y-auto">
                        <div className="flex min-h-full items-center justify-center p-4 text-center">
                            ...
                            >
                                ...
                                <h1 className='text-3xl text-right cursor-pointer' onClick={() => navigate(location.pathname, { replace: true })}> X</h1>
                                    <Dialog.Title
                                        as="h3"
