import { getProyectTeam, removeUserFromProject } from "@/api/TeamApi";
...
function ProjectTeamView() {
  ...
  const handleRemove = (userId: TeamMember["_id"]) => {
    const data = { projectId, userId: userId };
    mutate(data);
  };
  ...
  if (data)
    return (
      <>
        <h1 className="text-5xl font-black">Administrar Equipos</h1>
